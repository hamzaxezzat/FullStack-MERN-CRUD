  ...
  return (
    <Box>
      ...
      <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
        <form style={{marginTop:"20px", width:"100%",display:"flex",flexDirection:'column',gap:"20px", color:"black"}}
        onSubmit={handleSubmit(onFinishHandler)}>
          <FormControl>
            <FormHelperText sx={{fontWeight:500,margin:'10px 0',fontSize:16,color:"#11142d"}}>Enter Property Name:</FormHelperText>
            <TextField 
            sx={{color:"#11142d",border:".4px solid black", borderRadius:"5px"}}
              fullWidth
              required
              id="outlined-basic"
              color='info'
